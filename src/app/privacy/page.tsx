...
export default function PrivacyPage() {
  return (
    <div className="container mx-auto px-4 py-8">
       ...
       <Card>
         <CardHeader>
           <CardTitle>Politique de Confidentialité de SenPass Lite</CardTitle>
           <CardDescription>
             Dernière mise à jour : {new Date().toLocaleDateString('fr-FR')}
           </CardDescription>
         </CardHeader>
         <CardContent className="space-y-4">
           <p>Cette politique décrit comment SenPass Lite (Simulation) gère les informations.</p>
           <p><strong>1. Collecte d'Informations :</strong> SenPass Lite est une application de simulation. Elle <strong>ne collecte, ne stocke et ne traite aucune donnée personnelle réelle</strong> des utilisateurs de manière persistante. Les informations saisies (par exemple, nom, numéro CNI lors de l'inscription simulée) sont utilisées temporairement pour la démonstration et ne sont pas sauvegardées.</p>
