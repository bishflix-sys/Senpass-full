...
export default function TermsPage() {
  return (
    <div className="container mx-auto px-4 py-8">
       ...
       <Card>
         <CardHeader>
           <CardTitle>Conditions Générales d'Utilisation de SenPass Lite</CardTitle>
           <CardDescription>
             Dernière mise à jour : {new Date().toLocaleDateString('fr-FR')}
           </CardDescription>
         </CardHeader>
         <CardContent className="space-y-4">
           <p>Bienvenue sur SenPass Lite, une simulation de plateforme d'identité numérique.</p>
           ...
           <p><strong>5. Limitation de Responsabilité :</strong> Les créateurs de SenPass Lite ne peuvent être tenus responsables de toute interprétation erronée ou de toute conséquence découlant de l'utilisation de cette simulation.</p>
